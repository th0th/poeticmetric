...
func Test_service_Create(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setup: func() {
				mockValidationService.On("CreateOrganizationSiteParams", mock.Anything, uint(1), mock.Anything).Return(nil)
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, gotErr := s.CreateOrganizationSite(tt.args.ctx, tt.args.organizationID, tt.args.params)
			tt.wantErr(t, gotErr)
