...
type InnerVisitorProps = Overwrite<VisitorProps, {
...
export type VisitorProps = Omit<PropsWithoutRef<JSX.IntrinsicElements["svg"]>, "children">;

const padding = { bottom: 30, left: 54, top: 8 };

const xBisect = bisector((d: HydratedSiteVisitorReportDatum) => d.dateTimeDate).center;

function InnerVisitors({ className, report, ...props }: InnerVisitorProps) {
...
export default function Visitors({ ...props }: VisitorProps) {
